...
$sql="INSERT INTO `payment_details`(`order_id`, `cust_id`, `industry_type_id`, `channel_id`, `txn_ammount`, `email`, `msi_sdn`) VALUES (?,?,?,?,?,?,?)";
...
$paramList["CALLBACK_URL"] = "http://localhost/lakshya2020/PaymentGatwayNeel/pgResponse.php";
